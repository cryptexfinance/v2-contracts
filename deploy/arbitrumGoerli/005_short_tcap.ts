...
import { IController, IController__factory, IProduct } from '../../typechain-types'
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const productInfo: IProduct.ProductInfoStruct = {
        name: name,
        symbol: symbol,
        payoffDefinition: createPayoffDefinition({contractAddress: payoffProviderAddress, short: true}),
    ...
    await reuseOrDeployProduct(hre, coordinatorID, controller, productImpl, productInfo)
